      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        <View style={styles.container}>
          <View style={styles.helpBox}>
            ...
            <Text style={styles.basicText}>Use this form to add a new project</Text>
          </View>
          <View style={styles.formContainer}>
            <View style={styles.questionContainer}>
              <Text style={styles.questionText}>Project Name</Text>
              <TextInput
                style={styles.input}
            ...
            <View style={styles.questionContainer}>
              <Text style={styles.questionText}>Model Range</Text>
              <TextInput
                style={styles.input}
